...
for pr in pulls:
    ...
    requested_teams_slug = [team.slug for team in requested_teams]
    requested_reviewers_all = requested_reviewers_name + requested_teams_slug
    open_reviewers_zulip = [git_to_zulip.get(user, f"{user}") for user in requested_reviewers_all]
